...
////
////        Recipe recipe = new Recipe("Recipe", "url", "url");
////        Recipe chicken = new Recipe("Chicken", "chicken-url", "url");
////        Recipe alfredo = new Recipe("Alfredo", "alfredo.com", "url");
////
...
//
//        return args -> {
////            log.info("Preloading " + repository.save(new Recipe("ONE POT CREAMY CAJUN CHICKEN PASTA", "https://www.budgetbytes.com/one-pot-creamy-cajun-chicken-pasta/", "url")));
////            log.info("Preloading " + repository.save(new Recipe("EASY LEMON PEPPER CHICKEN", "https://www.budgetbytes.com/easy-lemon-pepper-chicken/", "url")));
